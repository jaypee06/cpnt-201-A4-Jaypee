...
- Maintainer:[John paul Adobas](https://github.com/jaypee06)
- Collaborator: [Raj Hunjan](https://github.com/Raj-Hunjan/scavengit-game)
- Contributor: [Christopher Barber](https://github.com/13retonnian/scavengit-game)


## Rules

1. Commit messages.
2. must have +1 before merging.
3. Dont add anyone else unless you have permission from the group.
